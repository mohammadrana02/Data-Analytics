...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 01, 2022 at 07:21 PM
...
(22, 'Elvis', 'Khoo', 'Child', 200),
(23, 'Sandra', 'Baida', 'Child', 116),
(24, 'Cameron', 'Tobias', 'Child', 100),
...
(110, 'John', 'Chen', 'john.chen@sqltutorial.org', '', '1997-09-28', 6, '8200.00', 108, 10),
...
--
ALTER TABLE `locations`
  ADD CONSTRAINT `fk` FOREIGN KEY (`country_id`) REFERENCES `countries` (`country_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
