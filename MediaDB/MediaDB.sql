...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2023 at 09:37 PM
...
--
-- Stand-in structure for view `asd`
...
(3, 'Peam', 'Jane', 'Sales Support Agent', 2, '1973-08-29 00:00:00', '2002-04-01 00:00:00', '1111 6 Ave SW', 'Calgary', 'AB', 'Canada', 'T2P 5M5', '+1 (403) 262-3443', '+1 (403) 262-6712', 'jane@chinookcorp.com'),
...
--
-- Structure for view `asd`
--
DROP TABLE IF EXISTS `asd`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `asd`  AS SELECT `employee`.`EmployeeId` AS `EmployeeId`, `employee`.`FirstName` AS `FirstName`, `employee`.`Address` AS `Address` FROM `employee` ;
...
--
ALTER TABLE `album`
  ADD CONSTRAINT `FK_AlbumArtistId` FOREIGN KEY (`ArtistId`) REFERENCES `artist` (`ArtistId`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `invoiceline`
  ...
  ADD CONSTRAINT `FK_InvoiceLineTrackId` FOREIGN KEY (`TrackId`) REFERENCES `track` (`TrackId`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
ALTER TABLE `playlisttrack`
  ...
  ADD CONSTRAINT `FK_PlaylistTrackTrackId` FOREIGN KEY (`TrackId`) REFERENCES `track` (`TrackId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `track`
--
ALTER TABLE `track`
  ADD CONSTRAINT `FK_TrackAlbumId` FOREIGN KEY (`AlbumId`) REFERENCES `album` (`AlbumId`) ON DELETE CASCADE ON UPDATE CASCADE,
